...
class SliderView : View() {
    ...
    private val distanceSlider = find<ConstraintSlider>(
    ...
    private val velocitySlider = find<ConstraintSlider>(
    ...
    private val accelerationSlider = find<ConstraintSlider>(
    ...
    private val jerkSlider = find<ConstraintSlider>(
    ...
    init {
        distanceSlider.valueProperty.onChange {
            if (it >= 0.5) trajectoryController.configureDistance(it.roundToInt())
        }
